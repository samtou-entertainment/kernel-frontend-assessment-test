...
<!--    <nav class="mb-4 sm:mb-0 sm:order-1" role="navigation" aria-label="Navigation">
    ...
    <div class="text-sm text-slate-500 text-center sm:text-left">
      Showing <!--<span class="font-medium text-slate-600">1</span> to <span class="font-medium text-slate-600">10</span> of-->
      <span class="font-medium text-slate-600">{{total}}</span> results
    </div>
  </div>
</template>
